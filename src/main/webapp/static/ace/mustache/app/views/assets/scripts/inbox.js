jQuery(function($){
	...
	$('.message-list .message-item:eq(0) .text').on('click', function() {
		...
		$('.message-inline-core').removeClass('message-inline-open').find('.message-content').remove();
	...
	$('.message-list .message-item:eq(1) .text').on('click', function(){
		...
		//if message is core, then close it
		if(message.hasClass('message-inline-core')) {
			message.removeClass('message-inline-core').find('.message-content').remove();
			return;
		}
