...
module.exports = function() {
 ...
 this.mark_items = function(navList , level) {
	...
	for(var i = 0 ; i < navList.length; i++)
	{
	 ...
	 if(item['submenu?'])
	 {
		...
		if(isOpen)
		{
			item['class'] = 'active core';//an item in the submenu of this item is active, so set this as "active" & "core"
 ...
 //therefore we need to reset the classes we assigned to previously "active" or "core" items and recalculate
