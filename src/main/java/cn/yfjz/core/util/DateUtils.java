...
public class DateUtils {
	...
	public final static String DATA_FORMAT = "MM-dd";
	...
	public static String isInDate(Date date, String strDateBegin,  
		...
		String flag = "";
		try {
			if(date.before(convertString2Date(DEFAILT_DATE_TIME_PATTERN,strDateBegin))){
				flag = "0";
			}
			if(date.after(convertString2Date(DEFAILT_DATE_TIME_PATTERN,strDateEnd))){
				flag = "2";
			}
			if(date.after(convertString2Date(DEFAILT_DATE_TIME_PATTERN,strDateBegin)) && date.before(convertString2Date(DEFAILT_DATE_TIME_PATTERN,strDateEnd))){
				flag = "1";
			}
		} catch (ParseException e) {
			e.printStackTrace();
